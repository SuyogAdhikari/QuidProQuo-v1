        ...
        <div id="content">
            <div class="col-2">
                ...
                <a href="../QuidProQuo.php" style="text-decoration:none;color:red;"><img src="../img/logo.png" class="logo" height="100px" width="180px"></a>
                    ...
                    <li style="background-color: #da8ff8;margin-left: -39px;"><a href="board.php"><i class="fas fa-home"></i><span class="text"> Home</span></a></li>
                        ...
                        if($image==NULL)
                          ...
                          <div class='col-lg-3 col-md-6 special-grid best-seller'>
                              <div class='products-single fix image'>
                                ...
                                <a href='ItemDescription.php' style='text-decoration:none;'>
                                  <div class='why-text'>
...
<?php
  ...
  if (isset($_POST['log_in']))
  {
      ...
      $user = $_POST['user'];
      $pass = md5($_POST['pass']);
      $check = "select username from user_login where username='$user' and password='$pass'";
      ...
      if ($result->num_rows > 0)
      {
          ...
          {
              echo "<h3 id='record_success'> welcome  ".$row['username'] . "</h3>";
              echo "<style>
                .logged_in{
                    display:block;
                }
      ...
      else 
      {
        ...
        //   echo "<h3 id='user_error'>Incorrect username or password</h3>";
          echo "<script>alert('Incorrect username or password');window.open('SignIn.php','_self');</script>";
        //   return false;
      }
  }
  else 
